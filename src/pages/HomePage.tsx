    ...
    <div className="container">
      ...
      <section className="py-20 text-center fade-in">
        ...
        <p className="body-large text-secondary mb-8 max-w-3xl mx-auto">
          Iron Capital combines advanced analytics with strategic investment insights 
          to deliver exceptional returns for our partners. Access professional-grade 
          tools and research that power informed investment decisions.
        </p>
      ...
      <section className="py-16 slide-up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Stock Screener Card */}
          <Link to="/screener" className="card glass hover:scale-105 transition-all duration-300 block">
            <div className="mb-4">
              ...
              <p className="text-secondary">
                Advanced filtering and analysis tools to identify investment opportunities
                based on fundamentals, technicals, and market data.
              </p>
            </div>
          </Link>

          {/* Company Search Card */}
          <Link to="/search" className="card glass hover:scale-105 transition-all duration-300 block">
            <div className="mb-4">
      ...
      <section className="py-20 text-center">
        <div className="glass p-12 rounded-3xl max-w-4xl mx-auto">
          ...
          <p className="body-large text-secondary mb-8">
            Join our exclusive investment partnership and gain access to institutional-grade 
