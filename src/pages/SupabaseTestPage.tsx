      ...
      <div className="max-w-4xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="bg-red-500/20 border border-red-500/50 text-red-200 px-4 py-3 rounded-lg">
              ...
              <p className="text-sm mt-2 text-red-300">
                Make sure you've created the "companies" table in Supabase and set up RLS policies.
              </p>
            </div>
          ) : (
            <div className="flex items-center gap-3">
              ...
              <span className="text-green-400">Connected! Found {companies.length} companies.</span>
            </div>
          )}
        </div>
                ...
                <tbody>
                  {companies.map((company) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-primary font-mono">{company.symbol}</td>
                      <td className="px-6 py-4 text-secondary">{company.sector || 'N/A'}</td>
        ...
        {!loading && !error && companies.length === 0 && (
          <div className="glass p-12 text-center">
            <p className="text-secondary mb-4">No companies found in the database.</p>
