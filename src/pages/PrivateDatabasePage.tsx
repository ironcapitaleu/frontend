      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-secondary body-large">
            This page demonstrates Row Level Security (RLS). You can only see your own notes.
          </p>
        </div>
        ...
        <div className="glass overflow-hidden">
          ...
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-tertiary text-sm">Add your first note above!</p>
            </div>
          ) : (
            <div className="divide-y divide-glass-border">
              {notes.map((note) => (
                <div key={note.id} className="p-6 hover:bg-glass-bg transition-colors">
