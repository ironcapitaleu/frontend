        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="glass p-12 rounded-xl fade-in">
            ...
            <p className="body-large text-secondary mb-8">
              ...
              Our team will review your information and prepare a customized consultation.
            </p>
            <button 
              onClick={() => { setIsSubmitted(false); setForm({
                name: '', email: '', company: '', phone: '', investmentAmount: '', message: '', newsletter: false
              }); }}
    ...
    <div className="container py-8">
      ...
      <div className="text-center mb-12 fade-in">
        ...
        <p className="body-large text-secondary max-w-3xl mx-auto">
          Ready to start your investment journey? Get in touch with our team to discuss 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} className="glass p-8 rounded-xl slide-up">
          ...
          <div className="glass p-6 rounded-xl">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-primary font-semibold">10:00 - 14:00</span>
              </div>
              <div className="flex justify-between">
            ...
            <p className="text-xs text-tertiary mt-4">
              CET/CEST timezone. Emergency contact available 24/7 for existing partners.
            </p>
          </div>
