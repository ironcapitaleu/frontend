    ...
    <div className="container py-8">
      ...
      <section className="text-center mb-16 fade-in">
        ...
        <p className="body-large text-secondary max-w-4xl mx-auto mb-8">
          Iron Capital is a premier investment partnership dedicated to delivering exceptional 
          returns through strategic analysis, cutting-edge technology, and disciplined risk management. 
          Founded on principles of transparency and excellence.
        </p>
      </section>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
        <div className="glass p-8 rounded-xl slide-up">
          ...
          <p className="text-secondary">
            To democratize institutional-grade investment research and provide our partners 
            with the tools and insights needed to make informed investment decisions in 
        ...
        <div className="glass p-8 rounded-xl slide-up">
          ...
          <p className="text-secondary">
            To become Europe's leading investment partnership by combining traditional 
            investment wisdom with innovative technology, creating sustainable wealth 
            for our partners while maintaining the highest ethical standards.
          </p>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="glass p-6 rounded-xl text-center">
            ...
            <p className="text-secondary">
              Comprehensive risk assessment and portfolio diversification strategies 
              protect capital while maximizing potential returns.
            </p>
          </div>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="glass p-6 rounded-xl text-center">
            ...
            <p className="text-primary font-semibold mb-3">Founding Partner & CEO</p>
            <p className="text-secondary text-sm">
              15+ years in institutional asset management. Former Goldman Sachs 
              executive with expertise in global equity markets and alternative investments.
            </p>
          </div>
          ...
          <div className="glass p-6 rounded-xl text-center">
            ...
            <p className="text-primary font-semibold mb-3">Chief Investment Officer</p>
            <p className="text-secondary text-sm">
              PhD in Finance from London School of Economics. Specialized in 
              quantitative analysis and risk management with 12 years at BlackRock.
            </p>
          </div>
        ...
        <div className="glass p-8 rounded-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center p-6 glass-strong rounded-xl">
              ...
              <p className="text-secondary font-semibold">Assets Under Management</p>
            ...
            <div className="text-center p-6 glass-strong rounded-xl">
              ...
              <p className="text-xs text-tertiary mt-1">Competitive industry rates</p>
            </div>
            <div className="text-center p-6 glass-strong rounded-xl">
              <div className="h1 text-primary mb-2">500+</div>
              <p className="text-secondary font-semibold">Active Partners</p>
              <p className="text-xs text-tertiary mt-1">Institutions & individuals</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="glass p-6 rounded-xl">
            ...
            <p className="text-secondary">
              ...
              performance metrics, and investment strategies are clearly communicated 
          ...
          <div className="glass p-6 rounded-xl">
            ...
            <p className="text-secondary">
              We operate with the highest ethical standards, always putting 
              our partners' interests first and maintaining fiduciary responsibility.
            </p>
          </div>
          <div className="glass p-6 rounded-xl">
      ...
      <section className="text-center glass p-12 rounded-xl">
        ...
        <p className="body-large text-secondary mb-8 max-w-3xl mx-auto">
          Join our exclusive partnership and benefit from institutional-grade investment 
          management, advanced analytics, and personalized service.
        </p>
