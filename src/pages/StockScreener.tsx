...
const StockScreener: React.FC = () => {
  ...
  const filteredAndSortedStocks = useMemo(() => {
    let filtered = mockStocks.filter(stock => {
      ...
      return matchesSearch && matchesSector && matchesPriceMin && matchesPriceMax;
    });
    ...
    <div className="container py-8">
      <div className="mb-8">
        ...
        <p className="text-secondary body-large">
          Discover investment opportunities with our advanced stock screening tools
        </p>
      </div>
      ...
      <div className="glass rounded-xl overflow-hidden">
        <div className="p-6 border-b border-glass-border">
          <h2 className="h3">Results ({filteredAndSortedStocks.length} stocks)</h2>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-glass-border">
                ...
                >
                  P/E Ratio {sortConfig?.key === 'peRatio' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
                </th>
            ...
            <tbody>
              {filteredAndSortedStocks.map((stock) => (
                <tr key={stock.symbol} className="border-b border-glass-border hover:bg-glass-bg transition-colors">
                  <td className="p-4">
                  ...
                  <td className="p-4">
                    <span className="text-secondary">{formatNumber(stock.volume)}</span>
                  </td>
                  <td className="p-4">
                    <span className="text-secondary">${formatNumber(stock.marketCap)}</span>
                  </td>
                  <td className="p-4">
                    <span className="text-secondary">{stock.peRatio ? stock.peRatio.toFixed(1) : '-'}</span>
                  </td>
                  <td className="p-4">
