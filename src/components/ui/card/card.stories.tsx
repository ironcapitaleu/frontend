...
export const Default: Story = {
  ...
  render: (args) => (
    <Card {...args} className="max-w-md">
      ...
      <CardContent>
        <p>This card uses the default size with standard padding (16px) and gap spacing.</p>
      </CardContent>
      <CardFooter>
...
export const Small: Story = {
  ...
  render: (args) => (
    <Card {...args} className="max-w-md">
      ...
      <CardContent>
        <p>This card uses the small size with compact padding (12px) and gap spacing.</p>
      </CardContent>
      <CardFooter>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-2">
        <Card size="default" className="max-w-md">
          ...
          <CardContent>
            <p>This card demonstrates the default size with standard spacing.</p>
          </CardContent>
          <CardFooter>
            <Button size="sm">Action</Button>
          </CardFooter>
        </Card>
        <p className="text-xs text-muted-foreground text-center">size="default"</p>
      </div>
