...
const meta: Meta<TabsStoryArgs> = {
  ...
  argTypes: {
    ...
    defaultValue: { control: 'inline-radio', options: ['account', 'password', 'settings'] },
...
function TabsStory({ listVariant, orientation, defaultValue, disableSettings }: TabsStoryArgs) {
  return (
