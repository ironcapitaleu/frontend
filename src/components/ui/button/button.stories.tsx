...
import { Button, BUTTON_VARIANTS, BUTTON_TEXT_SIZES, BUTTON_ICON_SIZES } from './button';
...
// Interactive Button
function InteractiveButtonExample({ size = 'default' }: { size?: (typeof BUTTON_TEXT_SIZES)[number] }) {
...
export const InteractiveWithActions: Story = {
  ...
  render: (args) => <InteractiveButtonWithActionsExample onClick={args.onClick} />,
};
